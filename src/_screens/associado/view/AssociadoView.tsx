...
const novoLancamento: NovoLancamento = {
    ...
    datalancamento : datalancamento, // ou outro valor
    description: description // ou outra descrição
  };
  ...
  if( dataNovoFilter.event === 'FILTER_EXTRATO_SUCCESS' ){
    ...
    setdialogFilter(false);      // fecha o modal
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="font-bold pl-4 mt-0">
          ...
          {/* <span className="p-1 text-[20px]">{dadosAssociado?.nome ?? idassociado}</span> */}
          ...
          <TableBody>
            {paginatedData.map((data) => (
              ...
              <TableRow key={data.id_split}>
                ...
                {/* <TableCell className="font-medium text-blue-600">{data.numero_fatura}</TableCell> */}
